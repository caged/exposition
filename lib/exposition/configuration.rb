module Exposition
  class Configuration
    ...
    # The location XCode can find the update feed for this docset
    attr_accessor :feed_url
    
    # The download url for the xar file generated by docsetutil used in the feed urls
    attr_accessor :download_url
    
    # The version number for the documentation.  This doesn't need to be the same as your 
    # product version.
